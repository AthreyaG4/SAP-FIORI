...
button.addEventListener("click",async () => {
    ...
    for(let i=0;i<appnames.length;i++){
        if(appnames[i]){
            ...
            let response = await fetch(`https://fioriappslibrary.hana.ondemand.com/sap/fix/externalViewer/services/SingleApp.xsodata/InputFilterParam(InpFilterValue='${appnameUrlEncoded}')/Results`);
